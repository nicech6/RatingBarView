...
public class RatingBarView extends LinearLayout {
    ...
    public RatingBarView(Context context, AttributeSet attrs) {
        ...
        starImageSize = mTypedArray.getDimension(R.styleable.RatingBarView_starImageSize, 20);
        starPadding = mTypedArray.getDimension(R.styleable.RatingBarView_starPadding, 10);
        starStep = mTypedArray.getFloat(R.styleable.RatingBarView_starStep, 1.0f);
        stepSize = StepSize.fromStep(mTypedArray.getInt(R.styleable.RatingBarView_stepSize, 1));
